<template>
  <div class="detail">
    ...
    <van-goods-action>
      <van-goods-action-icon :to="{name: 'Shopbag'}" icon="bag" text="购物袋" :badge="bagCount == 0 ? '' : bagCount" :color="bagCount > 0 ? '#8a4a2e' : '#646566'" />
      <van-goods-action-icon icon="like" :text="isLike ? '已收藏' : '未收藏'" :color="isLike ? '#8a4a2e6' : '#646566'" @click="toggleLikeProduct" />
      <van-goods-action-button text="加入购物袋" color=" #8a4a2ecc" @click="addShopbag()" />
      <van-goods-action-button text="立即购买" color=" #8a4a2e" @click="buy(true)" />
    </van-goods-action>
